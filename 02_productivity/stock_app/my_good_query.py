...
# Loads API key from 02_productivity/stock_app/.env and fetches time-series EOD data from Marketstack.
...
# Load .env from same folder as this script (02_productivity/stock_app)
...
if not API_KEY:
    raise ValueError(
        "API_KEY not found in .env. Add API_KEY=your_key to 02_productivity/stock_app/.env "
