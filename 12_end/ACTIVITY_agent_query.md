...
- [x] Open [`04_agent_query.R`](04_agent_query.R) or [`04_agent_query.py`](04_agent_query.py).
- [x] Find the `ENDPOINT_URL` variable near the top and paste in your live URL from the previous activity.
...
- [x] Change the prompt to something like:

> "Predict Brussels vehicle count for Monday at 8 AM."

- [x] Run the script and confirm the tool call uses `day_of_week` and `hour_of_day`.
- [x] Try one more day/hour prompt and confirm the tool call still maps correctly.
